...
const Footer = () => {
  ...
  return (
    <footer
      className={`pt-5 pb-3 ${isDark ? 'bg-dark text-white' : 'bg-light text-dark'}`}
        ...
        <div className="row gy-4">
          ...
          <div className="col-lg-4 col-md-12">
            <div className="d-flex align-items-center mb-3">
              ...
              />
              <h5 className="mb-0 fw-bold">CS PARANOX</h5>
            </div>
          ...
          <div className="col-lg-4 col-md-6">
            ...
            <ul className="list-unstyled">
              {mainLinks.map((link, idx) => (
                <li key={idx} className="mb-2">
                  <Link to={link.path} className="footer-link small text-decoration-none">
                    {link.name}
                  </Link>
                </li>
              ))}
            ...
            {/* LEGAL LINKS */}
            <h6 className="fw-bold mb-3 mt-4 text-uppercase small">Legal</h6>
                ...
                <div key={idx} className="d-flex align-items-center">
                  ...
                  <div>
                    ...
                    {info.link !== '#' ? (
                      <a
                        href={info.link}
                        className="small text-decoration-none opacity-75 text-reset"
                      >
                        {info.value}
                      </a>
                    ) : (
