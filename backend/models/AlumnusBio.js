...
const AlumnusBio = sequelize.define('AlumnusBio', {
  ...
  connected_to: { type: DataTypes.TEXT, allowNull: true },
  avatar: { type: DataTypes.TEXT, allowNull: true },
  status: { type: DataTypes.BOOLEAN, defaultValue: 0, comment: '0= Unverified, 1= Verified' },
  date_created: { type: DataTypes.DATEONLY, defaultValue: DataTypes.NOW }
}, {
