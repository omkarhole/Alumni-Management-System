...
const con = ("../utils/db.js");
const jwt = ("jsonwebtoken");
const multer = ("multer");
const path = ("path");
const bcrypt = ("bcrypt");
const sendEmail = ("../utils/mailer.js");
...
// get counts of forums, jobs, events, upcoming events, alumni
...
// manage jobs route for both add and update
...
// event participate route working
...
// check if user already participated in event
...
// get all forums with comments count and user names
...
// get comments of a particular forum topic with user names
...
// update forum comment route working
...
// add comment to a particular forum topic route working
...
// get all gallery images route working
...
// delete gallery image route working
...
// add gallery image route working
...
// update alumni status route working
...
// get system settings route working
...
// get upcoming events route working
...
// manage jobs route for both add and update with email notification

// Function to get all student emails
...
// insert job and send email to all students
